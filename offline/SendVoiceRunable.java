...
public class SendVoiceRunable implements Runnable {
	...
	public SendVoiceRunable(String host, int port, AppNetService netService, WifiPeopleVO peerInfo, int second,String path, boolean isGroupMsg, String touid,
							String msgid) {
		this.host = host;
		this.port = port;
	...
	private boolean sendVoice(String host, int port, WifiPeopleVO peerInfo,int second,
								String path, boolean isGroupMsg, String touid) {
