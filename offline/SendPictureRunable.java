...
/**
 * @TODO  Send picture chat messages
 */
public class SendPictureRunable implements Runnable {
	private String path;
	...
	public SendPictureRunable(String host, int port, AppNetService netService, WifiPeopleVO peerInfo, String path, boolean isGroupMsg, String touid,String msgid) {
		this.host = host;
		this.port = port;
	...
	@Override
	public void run() {
		if (sendPicture(host, port, peerInfo, path, isGroupMsg, touid)){// successed
	...
	private boolean sendPicture(String host, int port, WifiPeopleVO peerInfo,String path, boolean isGroupMsg, String touid) {
