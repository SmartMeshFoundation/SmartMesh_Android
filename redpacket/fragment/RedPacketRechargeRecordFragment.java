...
public class RedPacketRechargeRecordFragment extends BaseFragment {
    ...
    public static RedPacketRechargeRecordFragment newInstance(Bundle bundle) {
        RedPacketRechargeRecordFragment instance = new RedPacketRechargeRecordFragment();
        if (bundle != null) {
